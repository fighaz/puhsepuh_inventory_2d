            ...
            <div class="row">
                    ...
                    <table class="table text-primary">
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" name="nama" id="nama_barang" class="form-control-sm" required>
                                </td>
                            </tr>
                            <tr>
                                <td><label for="qty" class="form-label">Jumlah</label></td>
                                <td><input type="number" name="jumlah" id="jumlah" class="form-control-sm" required></td>
                            </tr>
                            <tr>
                                <td><label for="qty" class="form-label">Tersedia</label></td>
                                <td><input type="number" name="tersedia" id="tersedia" class="form-control-sm" required>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-select-sm custom-button bg-white border-2 d-block rounded"
                                        aria-label="Default select example" name="asal" id="asalSelect">
                                        <?php foreach ($data['asal'] as $asal): ?>
                                        <option value="<?= $asal['id'] ?>" title="<?=$asal['keterangan']?>">
                                                <?= $asal['nama'] ?>
                                            </option>
                                        <?php endforeach; ?>
                            ...
                            <tr>
                                ...
                                <td><textarea rows="4" cols="50" name="keterangan" id="keterangan"
                                        class="form-control-sm"></textarea></td>
                            </tr>
                            <tr>
                                <td><label for="maintainer" class="form-label">Maintainer</label></td>
                                <td><input type="text" name="maintainer" id="maintainer" class="form-control-sm" required></td>
                            </tr>
                            <tr>
                                <td></td>
                ...
                <section class="upload-gambar col-md-4 pr-4 pt-3">
                    ...
                    <div class="image-upload-container border border-primary rounded">
                        <input type="file" name="gambar" id="gambar" class="form-control-sm" required>
                        <div class="highlight-text text-black">Drop disini</div>
                        <img id="preview" src="#" alt="Upload Gambar" style="display: none;">
    ...
    <script>
        document.getElementById('gambar').addEventListener('change', function (e) {
            ...
            $(".image-upload-container").removeClass('highlight');
